...
export default function CartDrawer() {
  ...
  /**
   * BEST SOLUTION: hasMounted will be false on the server and 
   * true on the client, resolving hydration without the useEffect ESLint error.
   */
      ...
      <div className={`fixed right-0 top-0 z-[999] w-full max-w-md bg-white h-full shadow-2xl flex flex-col transform transition-transform duration-300 ease-in-out ${
            ...
            cartItems.map((item, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[#10B981] font-bold text-sm mt-1">৳{item.salePrice}</div>
        ...
        <div className="p-4 border-t bg-white">
          <button 
            ...
            className="w-full bg-[#10B981] disabled:bg-gray-300 disabled:cursor-not-allowed text-white py-4 rounded-xl font-bold flex justify-between px-6 hover:bg-emerald-600 transition-all active:scale-[0.97] shadow-lg shadow-green-100"
          >
